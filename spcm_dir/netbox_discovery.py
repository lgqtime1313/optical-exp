...
SPC.spcm_dwDiscovery (pszVisa, SPC.uint32(dwMaxNumRemoteCards), SPC.uint32(dwMaxVisaStringLen), SPC.uint32(dwTimeout_ms))
...
SPC.spcm_dwSendIDNRequest (pszIdn, SPC.uint32(dwMaxNumRemoteCards), SPC.uint32(dwMaxIdnStringLen))
...
for sVISA in listsSpectrumDevices:
    ...
    lCardType = SPC.int32(0)
    SPC.spcm_dwGetParam_i32 (hCard, SPC_PCITYP, byref(lCardType))
    lCardSN = SPC.int32(0)
    SPC.spcm_dwGetParam_i32 (hCard, SPC_PCISERIALNO, byref(lCardSN))
    lNetboxType = SPC.int32(0)
    SPC.spcm_dwGetParam_i32 (hCard, SPC_NETBOX_TYPE, byref(lNetboxType))
    lNetboxSN = SPC.int32(0)
    SPC.spcm_dwGetParam_i32 (hCard, SPC_NETBOX_SERIALNO, byref(lNetboxSN))
    ...
    SPC.spcm_dwGetParam_ptr(hCard, SPC_PCITYP, pValueBuffer, qwValueBufferLen)
