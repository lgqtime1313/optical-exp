...
qwError = spcm_dwDefTransfer_i64(hCardAD, SPCM_BUF_DATA, SPCM_DIR_CARDTOPC, lNotifySize.value, pvData, 0, llBufferSizeInBytes.value)
if qwError != 0:  # != ERR_OK
    spcm_dwGetErrorInfo_i32(hCardAD, None, None, szErrorTextBuffer)
...
# plot first data block (enable the import of matplotlib at top of file to use this)
# plt.plot(plotData)
# plt.show()
